...
### Added
- Implemented parallel slide processing using `asyncio.Semaphore` to significantly reduce build times for multi-slide videos.
- Added automatic audio normalization (peak normalization) to ensure consistent and clear audio levels across all slides.

## [1.2.0] - 2026-02-03

### Changed
- Refactored settings logic to use dataclass-based automation for better maintainability.
